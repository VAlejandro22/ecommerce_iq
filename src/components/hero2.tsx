...
export function Hero2() {
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-b from-green-400 to-green-100 pt-28">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 pb-20 md:grid-cols-2 md:pb-28">
        ...
        <div className="pt-8 flex flex-col items-end text-right">
          ...
          <div className="mt-10 flex gap-4 justify-end">
            <Button className="bg-white text-gray-900 hover:bg-white/90">Ver colecciones</Button>
